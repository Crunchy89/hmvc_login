<div class="row">
  ...
  <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 register-card bg-opacity-8 animate fadeUp">
    <form class="login-form" action="<?=site_url('auth/register')?>" method="post">
      <div class="row">
        <div class="input-field col s12">
          <h5 class="ml-4 center-align">Register</h5>
        </div>
      </div>
      ...
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="password2" class="center-align red-text"><?=form_error('password2')?></label>
          <?php else:?>
      ...
      <div class="row">
        <div class="input-field col s12">
          <p class="margin medium-small center-align"><a href="<?=site_url('auth')?>">Already have an account? Login</a></p>
        </div>
      </div>
    </form>
  </div>
